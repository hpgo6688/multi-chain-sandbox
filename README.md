...
By default, this sandbox is set to using Ethereum Sepolia, Polygon Mumbai, and Solana Devnet. To use these networks with Phantom, please ensure you have enabled testnet mode within Phantom's "Developer Settings"
